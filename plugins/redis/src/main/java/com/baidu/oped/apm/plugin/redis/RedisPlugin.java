        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (constructorEditorBuilderArg1 != null) {
                    constructorEditorBuilderArg1.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisConstructorInterceptor");
                }
                ...
                if (constructorEditorBuilderArg2 != null) {
                    constructorEditorBuilderArg2.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisConstructorInterceptor");
                }
                ...
                if (constructorEditorBuilderArg3 != null) {
                    constructorEditorBuilderArg3.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisConstructorInterceptor");
                }
                ...
                if (constructorEditorBuilderArg4 != null) {
                    constructorEditorBuilderArg4.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisConstructorInterceptor");
                }
                ...
                if (constructorEditorBuilderArg5 != null) {
                    constructorEditorBuilderArg5.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisConstructorInterceptor");
                }
                ...
                for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters.chain(MethodFilters.name(JedisMethodNames.get()), MethodFilters.modifierNot(MethodFilters.SYNTHETIC)))) {
                    try {
                        method.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisMethodInterceptor", va(config.isIo()));
                    } catch (Exception e) {
    ...
    private void addJedisClientClassEditor(ProfilerPluginSetupContext context, RedisPluginConfig config) {
        context.addClassFileTransformer("redis.clients.jedis.Client", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                final InstrumentMethod constructorEditorBuilderArg1 = target.getConstructor("java.lang.String");
                if (constructorEditorBuilderArg1 != null) {
                    constructorEditorBuilderArg1.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisClientConstructorInterceptor");
                }

                final InstrumentMethod constructorEditorBuilderArg2 = target.getConstructor("java.lang.String", "int");
                if (constructorEditorBuilderArg2 != null) {
                    constructorEditorBuilderArg2.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisClientConstructorInterceptor");
                }
        ...
        context.addClassFileTransformer("redis.clients.jedis.Protocol", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters.chain(MethodFilters.name("sendCommand", "read"), MethodFilters.modifierNot(Modifier.PRIVATE)))) {
                    method.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.ProtocolSendCommandAndReadMethodInterceptor");
                }
        ...
        addJedisPipelineBaseExtendedClassEditor(context, config, "redis.clients.jedis.Pipeline", new TransformHandler() {
            ...
            public void handle(InstrumentClass target) throws InstrumentException {
                ...
                if (setClientMethodEditorBuilder != null) {
                    setClientMethodEditorBuilder.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisPipelineSetClientMethodInterceptor");
                }
                ...
                if (constructorEditorBuilder != null) {
                    constructorEditorBuilder.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisPipelineConstructorInterceptor");
                }
            }
        });
    }
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters.chain(MethodFilters.name(JedisPipelineMethodNames.get()), MethodFilters.modifierNot(MethodFilters.SYNTHETIC)))) {
                    try {
                        method.addInterceptor("com.baidu.oped.apm.plugin.redis.interceptor.JedisPipelineMethodInterceptor", va(config.isIo()));
                    } catch (Exception e) {
                        if (logger.isWarnEnabled()) {
                            logger.warn("Unsupported method " + method, e);
                        }
