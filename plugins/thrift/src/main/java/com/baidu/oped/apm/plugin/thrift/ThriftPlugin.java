...
import com.baidu.oped.apm.plugin.thrift.field.getter.TNonblockingTransportFieldGetter;
import com.baidu.oped.apm.plugin.thrift.field.getter.TTransportFieldGetter;
...
public class ThriftPlugin implements ProfilerPlugin {
    ...
    private void addTServiceClientEditor(ProfilerPluginSetupContext context, ThriftPluginConfig config) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (sendBase != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.TServiceClientSendBaseInterceptor";
                ...
                if (receiveBase != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.TServiceClientReceiveBaseInterceptor";
    ...
    private void addTAsyncClientManagerEditor(ProfilerPluginSetupContext context) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (call != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncClientManagerCallInterceptor";
    ...
    private void addTAsyncMethodCallEditor(ProfilerPluginSetupContext context) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (constructor != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallConstructInterceptor";
                ...
                if (start != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallStartInterceptor";
                ...
                if (doConnecting != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallInternalMethodInterceptor";
                ...
                if (doWritingRequestBody != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallDoWritingRequestBodyInterceptor";
                ...
                if (doReadingResponseBody != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallDoReadingResponseBodyInterceptor";
                ...
                if (cleanUpAndFireCallback != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallCleanUpAndFireCallbackInterceptor";
                ...
                if (onError != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.client.async.TAsyncMethodCallOnErrorInterceptor";
    ...
    private void addTBaseProcessorEditor(ProfilerPluginSetupContext context) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (process != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.server.TBaseProcessorProcessInterceptor";
    ...
    private void addProcessFunctionEditor(ProfilerPluginSetupContext context) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (process != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.server.ProcessFunctionProcessInterceptor";
                    process.addInterceptor(interceptor);
                }
    ...
    private void addTBaseAsyncProcessorEditor(ProfilerPluginSetupContext context) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (process != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.server.async.TBaseAsyncProcessorProcessInterceptor";
                    process.addInterceptor(interceptor);
                }
    ...
    private void addInterceptorsForRetrievingSocketAddresses(ProfilerPluginSetupContext context) {
        ...
        addTTransportEditor(context, "org.apache.thrift.transport.TSocket",
                "com.baidu.oped.apm.plugin.thrift.interceptor.transport.TSocketConstructInterceptor", new String[] { "java.net.Socket" }, new String[] {
        ...
        addTTransportEditor(context, "org.apache.thrift.transport.TFramedTransport",
                "com.baidu.oped.apm.plugin.thrift.interceptor.transport.wrapper.TFramedTransportConstructInterceptor",
        ...
        addTTransportEditor(context, "org.apache.thrift.transport.TFastFramedTransport",
                "com.baidu.oped.apm.plugin.thrift.interceptor.transport.wrapper.TFastFramedTransportConstructInterceptor", new String[] {
        ...
        addTTransportEditor(context, "org.apache.thrift.transport.TSaslClientTransport",
                "com.baidu.oped.apm.plugin.thrift.interceptor.transport.wrapper.TSaslTransportConstructInterceptor",
    ...
    private void addTNonblockingSocketEditor(ProfilerPluginSetupContext context) {
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (constructor != null) {
                    String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.transport.TNonblockingSocketConstructInterceptor";
                    constructor.addInterceptor(interceptor);
                }
        ...
        context.addClassFileTransformer(targetClassName, new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (target.hasField(ThriftConstants.FRAME_BUFFER_FIELD_IN_TRANS_)) {
                    ...
                    if (constructor != null) {
                        String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.server.nonblocking.FrameBufferConstructInterceptor";
                        constructor.addInterceptor(interceptor);
                    }
                }
                ...
                if (target.hasMethod("getInputTransport", "org.apache.thrift.transport.TTransport")) {
                    ...
                    if (getInputTransport != null) {
                        String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.server.nonblocking.FrameBufferGetInputTransportInterceptor";
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined,
                ...
                if (traceThriftClient) {
                    ...
                    if (writeFieldStop != null) {
                        String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.tprotocol.client.TProtocolWriteFieldStopInterceptor";
                ...
                if (traceThriftProcessor) {
                    ...
                    if (readFieldBegin != null) {
                        String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.tprotocol.server.TProtocolReadFieldBeginInterceptor";
                    ...
                    if (readTTypes != null) {
                        String tTypeCommonInterceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.tprotocol.server.TProtocolReadTTypeInterceptor";
                    ...
                    if (readMessageEnd != null) {
                        String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.tprotocol.server.TProtocolReadMessageEndInterceptor";
                    ...
                    if (readMessageBegin != null) {
                        String interceptor = "com.baidu.oped.apm.plugin.thrift.interceptor.tprotocol.server.TProtocolReadMessageBeginInterceptor";
