 ...
 */
package com.baidu.oped.apm.plugin.log4j;
...
public class Log4jPlugin implements ProfilerPlugin {
    ...
    public void setup(ProfilerPluginSetupContext context) {
        context.addClassFileTransformer("org.apache.log4j.spi.LoggingEvent", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor pluginContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                target.addInterceptor("com.baidu.oped.apm.plugin.log4j.interceptor.LoggingEventOfLog4jInterceptor");
