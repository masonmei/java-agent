...
public class HttpClient4Plugin implements ProfilerPlugin {
    ...
    private void addHttpRequestExecutorClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.protocol.HttpRequestExecutor", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (execute != null) {
                    execute.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpRequestExecutorExecuteMethodInterceptor");
                }
                ...
                if (doSendRequest != null) {
                    doSendRequest.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpRequestExecutorDoSendRequestAndDoReceiveResponseMethodInterceptor");
                }
                ...
                if (doReceiveResponse != null) {
                    doReceiveResponse.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpRequestExecutorDoSendRequestAndDoReceiveResponseMethodInterceptor");
                }
    ...
    private void addAbstractHttpClient4Class(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.client.AbstractHttpClient", new TransformCallback() {
    ...
    private void addCloseableHttpClientClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.client.CloseableHttpClient", new TransformCallback() {
    ...
    private void injectHttpClientExecuteMethodWithHttpRequestInterceptor(InstrumentClass target, boolean isHasCallbackParam, String... parameterTypeNames) throws InstrumentException {
        ...
        if (execute != null) {
            execute.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpClientExecuteMethodWithHttpRequestInterceptor", va(isHasCallbackParam));
            execute.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpClientExecuteMethodInternalInterceptor", va(isHasCallbackParam));
        }
    }
    ...
    private void injectHttpClientExecuteMethodWithHttpUriRequestInterceptor(InstrumentClass target, boolean isHasCallbackParam, String... parameterTypeNames) throws InstrumentException {
        ...
        if (execute != null) {
            execute.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpClientExecuteMethodWithHttpUriRequestInterceptor", va(isHasCallbackParam));
            execute.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpClientExecuteMethodInternalInterceptor", va(isHasCallbackParam));
        }
    }

    private void addDefaultHttpRequestRetryHandlerClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.client.DefaultHttpRequestRetryHandler", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (retryRequest != null) {
                    retryRequest.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.DefaultHttpRequestRetryHandlerRetryRequestMethodInterceptor");
                }
    ...
    private void addAbstractPooledConnAdapterClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.conn.AbstractPooledConnAdapter", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (open != null) {
                    open.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.ManagedClientConnectionOpenMethodInterceptor");
                }
    ...
    private void addManagedClientConnectionImplClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.conn.ManagedClientConnectionImpl", new TransformCallback() {
    ...
    private void addBasicHttpClientConnectionManagerClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.conn.BasicHttpClientConnectionManager", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (connect != null) {
                    connect.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpClientConnectionManagerConnectMethodInterceptor");
                }
    ...
    private void addPoolingHttpClientConnectionManagerClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.conn.PoolingHttpClientConnectionManager", new TransformCallback() {
    ...
    private void addClosableHttpAsyncClientClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.nio.client.CloseableHttpAsyncClient", new TransformCallback() {
            ...
            private void injectHttpAsyncClientExecuteMethodInterceptor(InstrumentClass target, String... parameterTypeNames) throws InstrumentException {
                ...
                if (execute != null) {
                    execute.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.HttpAsyncClientExecuteMethodInterceptor");
                }
            }
        });
    }
    ...
    private void addDefaultClientExchangeHandlerImplClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.impl.nio.client.DefaultClientExchangeHandlerImpl", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (start != null) {
                    start.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.DefaultClientExchangeHandlerImplStartMethodInterceptor");
                }
    ...
    private void addBasicFutureClass(ProfilerPluginSetupContext context, HttpClient4PluginConfig config) {
        context.addClassFileTransformer("org.apache.http.concurrent.BasicFuture", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (get != null) {
                    get.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.BasicFutureMethodInterceptor");
                }
                
                InstrumentMethod get2 = target.getDeclaredMethod("get", "long", "java.util.concurrent.TimeUnit");
                if (get2 != null) {
                    get2.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.BasicFutureMethodInterceptor");
                }
                
                InstrumentMethod completed = target.getDeclaredMethod("completed", "java.lang.Object");
                if (completed != null) {
                    completed.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.BasicFutureMethodInterceptor");
                }
                
                InstrumentMethod failed = target.getDeclaredMethod("failed", "java.lang.Exception");
                if (failed != null) {
                    failed.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.BasicFutureMethodInterceptor");
                
                }
                
                InstrumentMethod cancel = target.getDeclaredMethod("cancel", "boolean");
                if (cancel != null) {
                    cancel.addInterceptor("com.baidu.oped.apm.plugin.httpclient4.interceptor.BasicFutureMethodInterceptor");
                }
