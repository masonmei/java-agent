...
package com.baidu.oped.apm.plugin.thrift.common.server;
...
import com.baidu.oped.apm.plugin.thrift.common.client.AsyncEchoTestClient;
import com.baidu.oped.apm.plugin.thrift.common.client.SyncEchoTestClient;
...
public abstract class AsyncEchoTestServer<T extends AbstractNonblockingServer> extends EchoTestServer<T> {
    ...
    public void verifyServerTraces(PluginTestVerifier verifier) throws Exception {
        ...
        verifier.verifyTrace(root("THRIFT_SERVER", // ServiceType,
                ...
                "com.baidu.oped.apm/plugin/thrift/dto/EchoService/echo", // rpc
