...
package com.baidu.oped.apm.plugin.thrift.common.client;
...
import com.baidu.oped.apm.bootstrap.plugin.test.ExpectedTrace;
import com.baidu.oped.apm.bootstrap.plugin.test.PluginTestVerifier;
import com.baidu.oped.apm.plugin.thrift.common.TestEnvironment;
import com.baidu.oped.apm.plugin.thrift.dto.EchoService;
import com.baidu.oped.apm.plugin.thrift.dto.EchoService.AsyncClient.echo_call;
...
public class AsyncEchoTestClient implements EchoTestClient {
    ...
    public void verifyTraces(PluginTestVerifier verifier, String expectedMessage) throws Exception {
        ...
        ExpectedAnnotation thriftUrl = Expectations.annotation("thrift.url", actualServerAddress.getHostName() + ":"
                + actualServerAddress.getPort() + "/com.baidu.oped.apm/plugin/thrift/dto/EchoService/echo_call");
