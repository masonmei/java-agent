 ...
 *
 */
public class ApmPluginTestSuite extends AbstractApmPluginTestSuite implements ApmPluginTestConstants {
    ...
    public ApmPluginTestSuite(Class<?> testClass) throws InitializationError, ArtifactResolutionException, DependencyResolutionException {
        super(testClass);
    ...
    @Override
    protected List<ApmPluginTestInstance> createTestCases(ApmPluginTestContext context) throws Exception {
    ...
    private List<ApmPluginTestInstance> createCasesWithJdkOnly(ApmPluginTestContext context) {
        List<ApmPluginTestInstance> cases = new ArrayList<ApmPluginTestInstance>();
    ...
    private List<ApmPluginTestInstance> createCasesWithLibraryPath(ApmPluginTestContext context) {
    ...
    private List<ApmPluginTestInstance> createCasesWithDependencies(ApmPluginTestContext context) throws ArtifactResolutionException, DependencyResolutionException {
        List<ApmPluginTestInstance> cases = new ArrayList<ApmPluginTestInstance>();
    ...
    private class NormalPluginTestCase implements ApmPluginTestInstance {
        private final ApmPluginTestContext context;
        private final String testId;
        private final List<String> libs;
        private final boolean onSystemClassLoader;
        
        public NormalPluginTestCase(ApmPluginTestContext context, String testId, List<String> libs, boolean onSystemClassLoader) {
        ...
        public String getMainClass() {
            return ForkedApmPluginTest.class.getName();
        }
