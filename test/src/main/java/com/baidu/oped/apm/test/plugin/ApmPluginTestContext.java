 ...
 *
 */
public class ApmPluginTestContext {
    ...
    public ApmPluginTestContext(String agentJar, String configFile, List<String> requiredLibraries, Class<?> testClass, String testClassLocation, String[] jvmArguments, boolean debug, int jvmVersion, String javaExecutable) {
