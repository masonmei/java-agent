...
public class TJvmGc implements org.apache.thrift.TBase<TJvmGc, TJvmGc._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField JVM_MEMORY_HEAP_INIT_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmMemoryHeapInit", org.apache.thrift.protocol.TType.I64, (short)4);
  private static final org.apache.thrift.protocol.TField JVM_MEMORY_HEAP_COMMITTED_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmMemoryHeapCommitted", org.apache.thrift.protocol.TType.I64, (short)5);
  private static final org.apache.thrift.protocol.TField JVM_MEMORY_NON_HEAP_USED_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmMemoryNonHeapUsed", org.apache.thrift.protocol.TType.I64, (short)6);
  private static final org.apache.thrift.protocol.TField JVM_MEMORY_NON_HEAP_MAX_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmMemoryNonHeapMax", org.apache.thrift.protocol.TType.I64, (short)7);
  private static final org.apache.thrift.protocol.TField JVM_MEMORY_NON_HEAP_INIT_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmMemoryNonHeapInit", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField JVM_MEMORY_NON_HEAP_COMMITTED_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmMemoryNonHeapCommitted", org.apache.thrift.protocol.TType.I64, (short)9);
  private static final org.apache.thrift.protocol.TField JVM_GC_OLD_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmGcOldCount", org.apache.thrift.protocol.TType.I64, (short)10);
  private static final org.apache.thrift.protocol.TField JVM_GC_OLD_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("jvmGcOldTime", org.apache.thrift.protocol.TType.I64, (short)11);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    JVM_MEMORY_HEAP_INIT((short)4, "jvmMemoryHeapInit"),
    JVM_MEMORY_HEAP_COMMITTED((short)5, "jvmMemoryHeapCommitted"),
    JVM_MEMORY_NON_HEAP_USED((short)6, "jvmMemoryNonHeapUsed"),
    JVM_MEMORY_NON_HEAP_MAX((short)7, "jvmMemoryNonHeapMax"),
    JVM_MEMORY_NON_HEAP_INIT((short)8, "jvmMemoryNonHeapInit"),
    JVM_MEMORY_NON_HEAP_COMMITTED((short)9, "jvmMemoryNonHeapCommitted"),
    JVM_GC_OLD_COUNT((short)10, "jvmGcOldCount"),
    JVM_GC_OLD_TIME((short)11, "jvmGcOldTime");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // JVM_MEMORY_HEAP_INIT
          return JVM_MEMORY_HEAP_INIT;
        case 5: // JVM_MEMORY_HEAP_COMMITTED
          return JVM_MEMORY_HEAP_COMMITTED;
        case 6: // JVM_MEMORY_NON_HEAP_USED
          return JVM_MEMORY_NON_HEAP_USED;
        case 7: // JVM_MEMORY_NON_HEAP_MAX
          return JVM_MEMORY_NON_HEAP_MAX;
        case 8: // JVM_MEMORY_NON_HEAP_INIT
          return JVM_MEMORY_NON_HEAP_INIT;
        case 9: // JVM_MEMORY_NON_HEAP_COMMITTED
          return JVM_MEMORY_NON_HEAP_COMMITTED;
        case 10: // JVM_GC_OLD_COUNT
          return JVM_GC_OLD_COUNT;
        case 11: // JVM_GC_OLD_TIME
  ...
  private static final int __JVMMEMORYHEAPINIT_ISSET_ID = 2;
  private static final int __JVMMEMORYHEAPCOMMITTED_ISSET_ID = 3;
  private static final int __JVMMEMORYNONHEAPUSED_ISSET_ID = 4;
  private static final int __JVMMEMORYNONHEAPMAX_ISSET_ID = 5;
  private static final int __JVMMEMORYNONHEAPINIT_ISSET_ID = 6;
  private static final int __JVMMEMORYNONHEAPCOMMITTED_ISSET_ID = 7;
  private static final int __JVMGCOLDCOUNT_ISSET_ID = 8;
  private static final int __JVMGCOLDTIME_ISSET_ID = 9;
  ...
  public TJvmGc() {
    this.type = com.baidu.oped.apm.thrift.dto.TJvmGcType.UNKNOWN;
  ...
  public int compareTo(TJvmGc other) {
    ...
    TJvmGc typedOther = (TJvmGc)other;
    ...
    lastComparison = Boolean.valueOf(isSetJvmMemoryHeapInit()).compareTo(typedOther.isSetJvmMemoryHeapInit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmMemoryHeapInit()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmMemoryHeapInit, typedOther.jvmMemoryHeapInit);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmMemoryHeapCommitted()).compareTo(typedOther.isSetJvmMemoryHeapCommitted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmMemoryHeapCommitted()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmMemoryHeapCommitted, typedOther.jvmMemoryHeapCommitted);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetJvmMemoryNonHeapInit()).compareTo(typedOther.isSetJvmMemoryNonHeapInit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmMemoryNonHeapInit()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmMemoryNonHeapInit, typedOther.jvmMemoryNonHeapInit);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmMemoryNonHeapCommitted()).compareTo(typedOther.isSetJvmMemoryNonHeapCommitted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmMemoryNonHeapCommitted()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmMemoryNonHeapCommitted, typedOther.jvmMemoryNonHeapCommitted);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmGcOldCount()).compareTo(typedOther.isSetJvmGcOldCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmGcOldCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmGcOldCount, typedOther.jvmGcOldCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmGcOldTime()).compareTo(typedOther.isSetJvmGcOldTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmGcOldTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmGcOldTime, typedOther.jvmGcOldTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
