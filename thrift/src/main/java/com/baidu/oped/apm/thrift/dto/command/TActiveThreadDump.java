...
public class TActiveThreadDump implements org.apache.thrift.TBase<TActiveThreadDump, TActiveThreadDump._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TActiveThreadDump other) {
    ...
    TActiveThreadDump typedOther = (TActiveThreadDump)other;

    lastComparison = Boolean.valueOf(isSetExecTime()).compareTo(typedOther.isSetExecTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExecTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.execTime, typedOther.execTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetThreadDump()).compareTo(typedOther.isSetThreadDump());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThreadDump()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.threadDump, typedOther.threadDump);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
