...
public class TCpuLoad implements org.apache.thrift.TBase<TCpuLoad, TCpuLoad._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TCpuLoadStandardSchemeFactory());
  ...
  public int compareTo(TCpuLoad other) {
    ...
    TCpuLoad typedOther = (TCpuLoad)other;

    lastComparison = Boolean.valueOf(isSetJvmCpuLoad()).compareTo(typedOther.isSetJvmCpuLoad());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmCpuLoad()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmCpuLoad, typedOther.jvmCpuLoad);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSystemCpuLoad()).compareTo(typedOther.isSetSystemCpuLoad());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSystemCpuLoad()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.systemCpuLoad, typedOther.systemCpuLoad);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TCpuLoadStandardScheme extends StandardScheme<TCpuLoad> {
  ...
  private static class TCpuLoadTupleScheme extends TupleScheme<TCpuLoad> {
