...
public class TServiceInfo implements org.apache.thrift.TBase<TServiceInfo, TServiceInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public TServiceInfo(TServiceInfo other) {
    ...
    if (other.isSetServiceLibs()) {
      List<String> __this__serviceLibs = new ArrayList<String>();
      for (String other_element : other.serviceLibs) {
        __this__serviceLibs.add(other_element);
      }
  ...
  public int compareTo(TServiceInfo other) {
    ...
    TServiceInfo typedOther = (TServiceInfo)other;
    ...
    lastComparison = Boolean.valueOf(isSetServiceLibs()).compareTo(typedOther.isSetServiceLibs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetServiceLibs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.serviceLibs, typedOther.serviceLibs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
