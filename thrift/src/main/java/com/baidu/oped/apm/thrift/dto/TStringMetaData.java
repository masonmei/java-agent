...
public class TStringMetaData implements org.apache.thrift.TBase<TStringMetaData, TStringMetaData._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TStringMetaData other) {
    ...
    TStringMetaData typedOther = (TStringMetaData)other;
    ...
    lastComparison = Boolean.valueOf(isSetStringId()).compareTo(typedOther.isSetStringId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStringId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stringId, typedOther.stringId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
