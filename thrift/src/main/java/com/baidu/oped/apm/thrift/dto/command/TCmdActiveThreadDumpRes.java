...
public class TCmdActiveThreadDumpRes implements org.apache.thrift.TBase<TCmdActiveThreadDumpRes, TCmdActiveThreadDumpRes._Fields>, java.io.Serializable, Cloneable {
  ...
  public TCmdActiveThreadDumpRes(TCmdActiveThreadDumpRes other) {
    if (other.isSetThreadDumps()) {
      List<TActiveThreadDump> __this__threadDumps = new ArrayList<TActiveThreadDump>();
  ...
  public int compareTo(TCmdActiveThreadDumpRes other) {
    ...
    TCmdActiveThreadDumpRes typedOther = (TCmdActiveThreadDumpRes)other;

    lastComparison = Boolean.valueOf(isSetThreadDumps()).compareTo(typedOther.isSetThreadDumps());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThreadDumps()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.threadDumps, typedOther.threadDumps);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  TActiveThreadDump _elem42; // required
                  _elem42 = new TActiveThreadDump();
                  _elem42.read(iprot);
                  struct.threadDumps.add(_elem42);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            TActiveThreadDump _elem47; // required
            _elem47 = new TActiveThreadDump();
            _elem47.read(iprot);
            struct.threadDumps.add(_elem47);
          }
        }
        struct.setThreadDumpsIsSet(true);
      }
