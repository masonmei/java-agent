...
public class TAnnotation implements org.apache.thrift.TBase<TAnnotation, TAnnotation._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TAnnotation other) {
    ...
    TAnnotation typedOther = (TAnnotation)other;
