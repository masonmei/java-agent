...
public class TServerMetaData implements org.apache.thrift.TBase<TServerMetaData, TServerMetaData._Fields>, java.io.Serializable, Cloneable {
  ...
  public TServerMetaData(TServerMetaData other) {
    ...
    if (other.isSetVmArgs()) {
      List<String> __this__vmArgs = new ArrayList<String>();
      for (String other_element : other.vmArgs) {
        __this__vmArgs.add(other_element);
      }
      this.vmArgs = __this__vmArgs;
    }
    if (other.isSetServiceInfos()) {
      List<TServiceInfo> __this__serviceInfos = new ArrayList<TServiceInfo>();
  ...
  public int compareTo(TServerMetaData other) {
    ...
    TServerMetaData typedOther = (TServerMetaData)other;
    ...
    lastComparison = Boolean.valueOf(isSetVmArgs()).compareTo(typedOther.isSetVmArgs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVmArgs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.vmArgs, typedOther.vmArgs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
