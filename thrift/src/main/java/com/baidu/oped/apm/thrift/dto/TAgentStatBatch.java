...
public class TAgentStatBatch implements org.apache.thrift.TBase<TAgentStatBatch, TAgentStatBatch._Fields>, java.io.Serializable, Cloneable {
  ...
  public TAgentStatBatch(TAgentStatBatch other) {
    ...
    if (other.isSetAgentStats()) {
      List<TAgentStat> __this__agentStats = new ArrayList<TAgentStat>();
  ...
  public int compareTo(TAgentStatBatch other) {
    ...
    TAgentStatBatch typedOther = (TAgentStatBatch)other;
    ...
    lastComparison = Boolean.valueOf(isSetAgentStats()).compareTo(typedOther.isSetAgentStats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAgentStats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.agentStats, typedOther.agentStats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
