...
public class TAgentInfo implements org.apache.thrift.TBase<TAgentInfo, TAgentInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TAgentInfo other) {
    ...
    TAgentInfo typedOther = (TAgentInfo)other;
    ...
    lastComparison = Boolean.valueOf(isSetAgentVersion()).compareTo(typedOther.isSetAgentVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAgentVersion()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.agentVersion, typedOther.agentVersion);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetVmVersion()).compareTo(typedOther.isSetVmVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVmVersion()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.vmVersion, typedOther.vmVersion);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetServerMetaData()).compareTo(typedOther.isSetServerMetaData());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetServerMetaData()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.serverMetaData, typedOther.serverMetaData);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
