...
public class TMonitorInfo implements org.apache.thrift.TBase<TMonitorInfo, TMonitorInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TMonitorInfo other) {
    ...
    TMonitorInfo typedOther = (TMonitorInfo)other;

    lastComparison = Boolean.valueOf(isSetStackDepth()).compareTo(typedOther.isSetStackDepth());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStackDepth()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stackDepth, typedOther.stackDepth);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStackFrame()).compareTo(typedOther.isSetStackFrame());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStackFrame()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stackFrame, typedOther.stackFrame);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
