...
public class TAgentStat implements org.apache.thrift.TBase<TAgentStat, TAgentStat._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.AGENT_ID,_Fields.START_TIMESTAMP,_Fields.TIMESTAMP,_Fields.COLLECT_INTERVAL,_Fields.GC,_Fields.CPU_LOAD,_Fields.TRANSACTION,_Fields.METADATA};
  ...
  public int compareTo(TAgentStat other) {
    ...
    lastComparison = Boolean.valueOf(isSetCollectInterval()).compareTo(typedOther.isSetCollectInterval());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCollectInterval()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.collectInterval, typedOther.collectInterval);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
