...
public class TCommandThreadDump implements org.apache.thrift.TBase<TCommandThreadDump, TCommandThreadDump._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.NAME,_Fields.PENDING_TIME_MILLIS};
  ...
  public TCommandThreadDump() {
    this.type = com.baidu.oped.apm.thrift.dto.command.TThreadDumpType.TARGET;
  ...
  public int compareTo(TCommandThreadDump other) {
    ...
    TCommandThreadDump typedOther = (TCommandThreadDump)other;
    ...
    lastComparison = Boolean.valueOf(isSetPendingTimeMillis()).compareTo(typedOther.isSetPendingTimeMillis());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPendingTimeMillis()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.pendingTimeMillis, typedOther.pendingTimeMillis);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
