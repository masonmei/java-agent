...
public class TApiMetaData implements org.apache.thrift.TBase<TApiMetaData, TApiMetaData._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TApiMetaData other) {
    ...
    TApiMetaData typedOther = (TApiMetaData)other;
