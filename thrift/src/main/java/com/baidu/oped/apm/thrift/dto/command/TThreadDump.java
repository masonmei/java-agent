...
public class TThreadDump implements org.apache.thrift.TBase<TThreadDump, TThreadDump._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TThreadDumpStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TThreadDumpTupleSchemeFactory());
  }
  ...
  public TThreadDump(
    ...
    List<TMonitorInfo> lockedMonitors,
  ...
  public TThreadDump(TThreadDump other) {
    ...
    if (other.isSetStackTrace()) {
      List<String> __this__stackTrace = new ArrayList<String>();
      for (String other_element : other.stackTrace) {
        __this__stackTrace.add(other_element);
      }
      this.stackTrace = __this__stackTrace;
    }
    if (other.isSetLockedMonitors()) {
      List<TMonitorInfo> __this__lockedMonitors = new ArrayList<TMonitorInfo>();
    ...
    if (other.isSetLockedSynchronizers()) {
      List<String> __this__lockedSynchronizers = new ArrayList<String>();
      for (String other_element : other.lockedSynchronizers) {
        __this__lockedSynchronizers.add(other_element);
      }
  ...
  public void unsetBlockedTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __BLOCKEDTIME_ISSET_ID);
  }

  /** Returns true if field blockedTime is set (has been assigned a value) and false otherwise */
  public boolean isSetBlockedTime() {
    return EncodingUtils.testBit(__isset_bitfield, __BLOCKEDTIME_ISSET_ID);
  }

  public void setBlockedTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __BLOCKEDTIME_ISSET_ID, value);
  }
  ...
  public void unsetWaitedTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __WAITEDTIME_ISSET_ID);
  }

  /** Returns true if field waitedTime is set (has been assigned a value) and false otherwise */
  public boolean isSetWaitedTime() {
    return EncodingUtils.testBit(__isset_bitfield, __WAITEDTIME_ISSET_ID);
  }

  public void setWaitedTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __WAITEDTIME_ISSET_ID, value);
  }
  ...
  public void unsetWaitedCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __WAITEDCOUNT_ISSET_ID);
  }

  /** Returns true if field waitedCount is set (has been assigned a value) and false otherwise */
  public boolean isSetWaitedCount() {
    return EncodingUtils.testBit(__isset_bitfield, __WAITEDCOUNT_ISSET_ID);
  }

  public void setWaitedCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __WAITEDCOUNT_ISSET_ID, value);
  }
  ...
  public void unsetLockOwnerId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LOCKOWNERID_ISSET_ID);
  }

  /** Returns true if field lockOwnerId is set (has been assigned a value) and false otherwise */
  public boolean isSetLockOwnerId() {
    return EncodingUtils.testBit(__isset_bitfield, __LOCKOWNERID_ISSET_ID);
  }

  public void setLockOwnerIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LOCKOWNERID_ISSET_ID, value);
  }
  ...
  public void unsetInNative() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __INNATIVE_ISSET_ID);
  }

  /** Returns true if field inNative is set (has been assigned a value) and false otherwise */
  public boolean isSetInNative() {
    return EncodingUtils.testBit(__isset_bitfield, __INNATIVE_ISSET_ID);
  }

  public void setInNativeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __INNATIVE_ISSET_ID, value);
  }
  ...
  public void unsetSuspended() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SUSPENDED_ISSET_ID);
  }

  /** Returns true if field suspended is set (has been assigned a value) and false otherwise */
  public boolean isSetSuspended() {
    return EncodingUtils.testBit(__isset_bitfield, __SUSPENDED_ISSET_ID);
  }

  public void setSuspendedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SUSPENDED_ISSET_ID, value);
  }
  ...
  public java.util.Iterator<String> getStackTraceIterator() {
    return (this.stackTrace == null) ? null : this.stackTrace.iterator();
  }

  public void addToStackTrace(String elem) {
  ...
  public void addToLockedMonitors(TMonitorInfo elem) {
    if (this.lockedMonitors == null) {
      this.lockedMonitors = new ArrayList<TMonitorInfo>();
    }
  ...
  public void setLockedMonitors(List<TMonitorInfo> lockedMonitors) {
    this.lockedMonitors = lockedMonitors;
  }
  ...
  public java.util.Iterator<String> getLockedSynchronizersIterator() {
    return (this.lockedSynchronizers == null) ? null : this.lockedSynchronizers.iterator();
  }

  public void addToLockedSynchronizers(String elem) {
    if (this.lockedSynchronizers == null) {
      this.lockedSynchronizers = new ArrayList<String>();
    }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case STACK_TRACE:
      if (value == null) {
        ...
        setStackTrace((List<String>)value);
      }
      break;
    ...
    case LOCKED_MONITORS:
      if (value == null) {
        ...
        setLockedMonitors((List<TMonitorInfo>)value);
      }
      break;
    ...
    case LOCKED_SYNCHRONIZERS:
      if (value == null) {
        ...
        setLockedSynchronizers((List<String>)value);
      }
      break;
  ...
  public int compareTo(TThreadDump other) {
    ...
    TThreadDump typedOther = (TThreadDump)other;
    ...
    lastComparison = Boolean.valueOf(isSetBlockedTime()).compareTo(typedOther.isSetBlockedTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlockedTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blockedTime, typedOther.blockedTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetBlockedCount()).compareTo(typedOther.isSetBlockedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlockedCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blockedCount, typedOther.blockedCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWaitedTime()).compareTo(typedOther.isSetWaitedTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWaitedTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.waitedTime, typedOther.waitedTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWaitedCount()).compareTo(typedOther.isSetWaitedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWaitedCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.waitedCount, typedOther.waitedCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLockName()).compareTo(typedOther.isSetLockName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockName, typedOther.lockName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLockOwnerId()).compareTo(typedOther.isSetLockOwnerId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockOwnerId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockOwnerId, typedOther.lockOwnerId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLockOwnerName()).compareTo(typedOther.isSetLockOwnerName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockOwnerName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockOwnerName, typedOther.lockOwnerName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInNative()).compareTo(typedOther.isSetInNative());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInNative()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.inNative, typedOther.inNative);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSuspended()).compareTo(typedOther.isSetSuspended());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSuspended()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.suspended, typedOther.suspended);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetThreadState()).compareTo(typedOther.isSetThreadState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThreadState()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.threadState, typedOther.threadState);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetLockedMonitors()).compareTo(typedOther.isSetLockedMonitors());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockedMonitors()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockedMonitors, typedOther.lockedMonitors);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLockedSynchronizers()).compareTo(typedOther.isSetLockedSynchronizers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockedSynchronizers()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockedSynchronizers, typedOther.lockedSynchronizers);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TThreadDumpStandardScheme extends StandardScheme<TThreadDump> {
  ...
  private static class TThreadDumpTupleScheme extends TupleScheme<TThreadDump> {
      ...
      if (incoming.get(13)) {
        {
          ...
          {
            TMonitorInfo _elem20; // required
            _elem20 = new TMonitorInfo();
            _elem20.read(iprot);
            struct.lockedMonitors.add(_elem20);
          }
        }
        struct.setLockedMonitorsIsSet(true);
      }
      if (incoming.get(14)) {
        {
          ...
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            ...
            struct.lockedSynchronizers.add(_elem23);
          }
        }
        struct.setLockedSynchronizersIsSet(true);
      }
