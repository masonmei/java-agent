...
public class TSpan implements org.apache.thrift.TBase<TSpan, TSpan._Fields>, java.io.Serializable, Cloneable {
...
;
    ...
    if (other.isSetSpanEventList()) {
      List<TSpanEvent> __this__spanEventList = new ArrayList<TSpanEvent>();
  ...
  public int compareTo(TSpan other) {
    ...
    lastComparison = Boolean.valueOf(isSetApplicationServiceType()).compareTo(typedOther.isSetApplicationServiceType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApplicationServiceType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.applicationServiceType, typedOther.applicationServiceType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLoggingTransactionInfo()).compareTo(typedOther.isSetLoggingTransactionInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLoggingTransactionInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.loggingTransactionInfo, typedOther.loggingTransactionInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
      ...
      if (incoming.get(12)) {
        {
          ...
          {
            TAnnotation _elem20; // required
            _elem20 = new TAnnotation();
            _elem20.read(iprot);
      ...
      if (incoming.get(15)) {
        {
          ...
          {
            TSpanEvent _elem23; // required
            _elem23 = new TSpanEvent();
            _elem23.read(iprot);
            struct.spanEventList.add(_elem23);
          }
        }
        struct.setSpanEventListIsSet(true);
      }
