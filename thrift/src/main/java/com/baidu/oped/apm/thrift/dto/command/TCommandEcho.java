...
public class TCommandEcho implements org.apache.thrift.TBase<TCommandEcho, TCommandEcho._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TCommandEcho other) {
    ...
    TCommandEcho typedOther = (TCommandEcho)other;
