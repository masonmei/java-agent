...
public class TCommandTransferResponse implements org.apache.thrift.TBase<TCommandTransferResponse, TCommandTransferResponse._Fields>, java.io.Serializable, Cloneable {
...
;
  ...
  public int compareTo(TCommandTransferResponse other) {
    ...
    TCommandTransferResponse typedOther = (TCommandTransferResponse)other;

    lastComparison = Boolean.valueOf(isSetRouteResult()).compareTo(typedOther.isSetRouteResult());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRouteResult()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.routeResult, typedOther.routeResult);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
