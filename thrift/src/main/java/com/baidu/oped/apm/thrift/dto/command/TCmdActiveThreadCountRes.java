...
public class TCmdActiveThreadCountRes implements org.apache.thrift.TBase<TCmdActiveThreadCountRes, TCmdActiveThreadCountRes._Fields>, java.io.Serializable, Cloneable {
  ...
  public TCmdActiveThreadCountRes(TCmdActiveThreadCountRes other) {
    ...
    if (other.isSetActiveThreadCount()) {
      List<Integer> __this__activeThreadCount = new ArrayList<Integer>();
      for (Integer other_element : other.activeThreadCount) {
        __this__activeThreadCount.add(other_element);
      }
  ...
  public int compareTo(TCmdActiveThreadCountRes other) {
    ...
    TCmdActiveThreadCountRes typedOther = (TCmdActiveThreadCountRes)other;

    lastComparison = Boolean.valueOf(isSetHistogramSchemaType()).compareTo(typedOther.isSetHistogramSchemaType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHistogramSchemaType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.histogramSchemaType, typedOther.histogramSchemaType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  ...
                  struct.activeThreadCount.add(_elem34);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i38 = 0; _i38 < _list37.size; ++_i38)
          {
            ...
            struct.activeThreadCount.add(_elem39);
          }
        }
        struct.setActiveThreadCountIsSet(true);
      }
