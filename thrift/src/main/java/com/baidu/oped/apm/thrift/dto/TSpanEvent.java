...
public class TSpanEvent implements org.apache.thrift.TBase<TSpanEvent, TSpanEvent._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.SPAN_ID,_Fields.END_ELAPSED,_Fields.RPC,_Fields.END_POINT,_Fields.ANNOTATIONS,_Fields.DEPTH,_Fields.NEXT_SPAN_ID,_Fields.DESTINATION_ID,_Fields.API_ID,_Fields.EXCEPTION_INFO,_Fields.ASYNC_ID,_Fields.NEXT_ASYNC_ID,_Fields.ASYNC_SEQUENCE};
  ...
  public TSpanEvent(TSpanEvent other) {
    ...
    if (other.isSetAnnotations()) {
      List<TAnnotation> __this__annotations = new ArrayList<TAnnotation>();
  ...
  public int compareTo(TSpanEvent other) {
    ...
    lastComparison = Boolean.valueOf(isSetAsyncId()).compareTo(typedOther.isSetAsyncId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAsyncId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.asyncId, typedOther.asyncId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNextAsyncId()).compareTo(typedOther.isSetNextAsyncId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNextAsyncId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nextAsyncId, typedOther.nextAsyncId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAsyncSequence()).compareTo(typedOther.isSetAsyncSequence());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAsyncSequence()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.asyncSequence, typedOther.asyncSequence);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
