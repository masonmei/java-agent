 ...
 * @author Taejin Koo
 */
public class ApmByteArrayOutputStream extends ResettableByteArrayOutputStream {
     ...
     */
    public ApmByteArrayOutputStream() {
        this(32);
    }
     ...
     */
    public ApmByteArrayOutputStream(int size) {
        this(size, true);
    }
    
    public ApmByteArrayOutputStream(int size, boolean autoExpand) {
        super(size);
