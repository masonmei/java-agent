...
public class TSqlMetaData implements org.apache.thrift.TBase<TSqlMetaData, TSqlMetaData._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TSqlMetaData other) {
    ...
    TSqlMetaData typedOther = (TSqlMetaData)other;
    ...
    lastComparison = Boolean.valueOf(isSetSqlId()).compareTo(typedOther.isSetSqlId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSqlId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sqlId, typedOther.sqlId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
