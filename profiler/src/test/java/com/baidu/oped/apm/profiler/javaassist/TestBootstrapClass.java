...
import com.baidu.oped.apm.test.util.BytecodeUtils;
...
public class TestBootstrapClass {
    ...
    private static final String TEST_CLASS_NAME = "com.baidu.oped.apm.profiler.javaassist.DynamicTest";
    ...
    public void testReflection() throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        java.lang.Class<?> interceptorRegistry = contextClassLoader.loadClass("com.baidu.oped.apm.bootstrap.interceptor.registry.GlobalInterceptorRegistry");
