 ...
 * @author emeroad
 */
public final class ApmJUnit4ClassRunner extends BlockJUnit4ClassRunner {

    private static final Logger logger = LoggerFactory.getLogger(ApmJUnit4ClassRunner.class);

    private static TestContext testContext;

    public ApmJUnit4ClassRunner(Class<?> clazz) throws InitializationError {
        super(clazz);
        if (logger.isDebugEnabled()) {
            logger.debug("ApmJUnit4ClassRunner constructor called with [{}].", clazz);
        }
    }
