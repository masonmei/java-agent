...
import com.baidu.oped.apm.bootstrap.ApmURLClassLoader;
 ...
 * @author emeroad
 */
public class ApmURLClassLoaderTest {

    @Test
    public void testOnLoadClass() throws Exception {

        ApmURLClassLoader cl = new ApmURLClassLoader(new URL[]{}, Thread.currentThread().getContextClassLoader());
        try {
            cl.loadClass("test");
            Assert.fail();
