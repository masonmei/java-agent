...
public interface ApplicationTypeDetector {
     ...
     * with code in a range corresponding to {@link com.baidu.oped.apm.common.trace.ServiceTypeCategory#SERVER}
     * 
     * @return the {@link ServiceType} representing the current plugin
     * @see ServiceType#isWas()
     * @see com.baidu.oped.apm.common.trace.ServiceTypeCategory#SERVER
     */
